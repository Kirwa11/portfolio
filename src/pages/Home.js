...
function Home(){
    return(
        <div className="home-container">
            <img src="/images/my.jpeg" alt="Maxwell Kirwa" width="150" style={{borderRadius: '50%'}} />
            <h1>Kirwa Maxwell</h1>
            <p>
                <FaReact color="#ff0000" /> ReactJs | <FaReact color="#ff0000" /> Django | Full-Stack Developer
            </p>
            <p className="intro">
                ...
                I’m a proud graduate of eMobilis Technology Training Institute, where I gained strong technical skills in JavaScript, Kotlin, Java, React, Firebase, and more. I've worked on several mobile and web-based projects, including a multi-service booking app that handles hotel, conference room, car rental, and taxi bookings.

                I’m fluent in English and Kiswahili, a fast typist, an effective public speaker, and a strong team player. I thrive on continuous learning, building practical solutions, and contributing to real-world projects that make a difference.
            </p>
